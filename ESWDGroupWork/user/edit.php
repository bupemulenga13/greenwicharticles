...
if(isset($_REQUEST['btn_update']))
{
	try
	{
	   /*  $name	=$_REQUEST['txt_name'];	//textbox name "txt_name" */
		...
		if($image_file)
		{
			if($type = ['pdf', 'txt', 'doc', 'docx', 'png', 'PNG', 'jpg', 'jpeg',  'gif'] ) //check file extension
			{	
		...
		if(!isset($errorMsg))
		{
			$update_stmt=$db->prepare('UPDATE Articles SET name=:name_up, image=:file_up WHERE id=:id'); //sql update query
			...
			if($update_stmt->execute())
			{
				...
				header("refresh:3;user_home.php");	//refresh 3 second and redirect to index.php page
			}
		}
	}
	catch(PDOException $e)
	...
	<nav class="navbar navbar-default navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="edit.php">Greenwich Articles</a>
        </div>
 <!--   <div id="navbar" class="navbar-collapse collapse">
	...
	<div class="container">
	    ...
	    <!--    <div class="form-group">
				...
				<a href="user4.php" class="btn btn-danger">Cancel</a>
				</div>
				</div>
