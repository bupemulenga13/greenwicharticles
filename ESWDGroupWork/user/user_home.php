...
<title>Multiuser Login System in PHP PDO with MySQL :onlyxscript.blogspot.com</title>
	...
	<nav class="navbar navbar-default navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="user_home.php">Greenwich Articles</a>
        </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
									<?php
									$select_stmt=$db->prepare("SELECT * FROM Articles");	//sql select query
									$select_stmt->execute();
