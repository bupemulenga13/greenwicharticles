...
if(isset($_REQUEST['btn_insert']))
{
	...
	/*	if(empty($name)){
		...
		else if($type = ['pdf', 'txt', 'doc', 'docx', 'png', 'PNG', 'jpg', 'jpeg',  'gif']) //check file extension
		{	
		...
		if(!isset($errorMsg))
		{
			$insert_stmt=$db->prepare('INSERT INTO tbl_file(image) VALUES(:fimage)'); //sql insert query					
	...
	<nav class="navbar navbar-default navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="add.php">Greenwich Articles</a>
        </div>
